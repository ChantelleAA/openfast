...
## What was analyzed
- Primary EVA variable: area-mean `vhub_10min_from100_mean` (from 100 m).
...
## POT choices
- Threshold quantile: q=0.95 (u=20.99 m/s).
- Declustered peaks used: 801.
- Fitted GPD shape xi=-0.265.

## Return-level results (sorted by 100-year estimate)
- Weibull_block_max: 50y=33.52 m/s, 100y=33.79 m/s
- GEV_block_max: 50y=33.59 m/s, 100y=33.87 m/s
- POT_GPD: 50y=34.02 m/s, 100y=34.40 m/s
- Lognormal_block_max: 50y=34.06 m/s, 100y=34.57 m/s
- Gumbel_block_max: 50y=35.63 m/s, 100y=36.68 m/s
